# Generated by Django 5.0 on 2026-02-19 15:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('salary', models.DecimalField(blank=True, decimal_places=2, help_text='Please list the annual salary in USD here', max_digits=10, null=True)),
                ...
                ('remote', models.CharField(choices=[('remote', 'Remote'), ('on_site', 'On-site'), ('hybrid', 'Hybrid')], default='on_site', max_length=10)),
                ('visa_sponsorship', models.CharField(choices=[('yes', 'Visa Sponsorship Available'), ('no', 'No Sponsorship Available')], max_length=3)),
